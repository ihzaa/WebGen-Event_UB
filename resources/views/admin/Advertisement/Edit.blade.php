        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <!--  -->
                        <form action="{{route('admin_advertisement_update', ['id'=>$data->id])}}" method="POST" role="form" id="tambahGambar" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                <div class="form-group">
                                    @csrf
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" id="imgInp" value={{old('image')}} required name="image" {{request()->is('*/kelolaAdvertisement/update*')?"required":""}} name="image">

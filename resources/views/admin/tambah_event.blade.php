...
@section('content')
{{-- <div class="row"> --}}
<form action="{{route('admin_tambah_event_post')}}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="row">
        @if ($errors->any())
        <div class="col-md-12">
                        ...
                        <div class="col-md-8 d-flex">
                            <div class="form-group col-md-12 my-auto">
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="poster" required name="poster">
